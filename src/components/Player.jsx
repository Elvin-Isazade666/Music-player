    ...
    return (
        <PlayerContainer>
            ...
            <PlayControlContainer>
                <AiFillBackward size={35} style={{cursor:"pointer"}} onClick={()=>skipTrackHandler("skip-back")} />
				{
					isPlaying ? <BsFillPauseFill onClick={playSongHandler} size={35} style={{cursor:"pointer"}} /> : <BsFillPlayFill onClick={playSongHandler} size={35} style={{cursor:"pointer"}} />
				}
                <AiFillFastForward onClick={()=>skipTrackHandler("skip-forward")} size={35} style={{cursor:"pointer"}} />
            </PlayControlContainer>
        </PlayerContainer>
    )
}
